...
public class BotOmnilink extends VBot {
	...
	public interface STATES {
		...
		String ESPELHAMENTO= "espelhamento";
        ...
        String MAX_NO_INPUT = "MAX_NO_INPUT";
        String MAX_INPUT_ERROR = "MAX_INPUT_ERROR";
		...
		m.put("MAX_NO_INPUT", new BotState("/") {
			{
				...
				setPosFunction((botState, inputResult) -> {
					return (new BotStateFlow(BotStateFlow.Flow.CONTINUE, "#FINALIZAR"));
